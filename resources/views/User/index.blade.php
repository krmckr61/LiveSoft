...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <a href="{!! url('users/add') !!}" class="btn btn-success pull-right m-b-10">
                    <i class="fa fa-plus"></i> Yeni Ekle
                </a>
                <div class="table-container high">
                    <table class="table table-striped table-bordered table-hover table-has-transactions"
                           id="datatable_ajax" data-url="/users/getDatas">
                        <thead>
                        <tr role="row" class="heading">
                            <th width="3%">A/P</th>
                            <th width="5%">Adı Soyadı</th>
                            <th width="5%">E-Posta Adresi</th>
