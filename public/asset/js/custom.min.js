...
$(document).ready(function() {
    ...
    $(function() {
        ...
        $(".right-sidebar.color-schema").slideDown(50).toggleClass("shw-rside"), $(".fxhdr").on("click", function() {
