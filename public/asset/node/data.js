...
function namePhone(rowNumber) {
    ...
    var nameCol = $('.ui-datatable-selectable:nth-child(' + rowNumber + ') td:nth-child(10)');
...
function getPhoneNumber () {
    ...
    $("table#ctatt tbody tr").each( function(i) {
        ...
        if(cell == 'Telefon' || cell == 'Sender No' || cell == 'Receiver No' || cell == 'Alicinin Telefon Numarasi' || cell == 'Gondericinin Telefon Numarasi') {
