...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"İleri",sPrevious:"Geri"},sEmptyTable:"Kayıt bulunamadı",sInfo:"_START_ ile _END_ aralığında - toplam <span class='total-count'>_TOTAL_</span> kayıt",sInfoEmpty:"0 ile 0 aralığında || toplam 0 kayıt",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Gösterilen kayıt sayısı : _MENU_",sLoadingRecords:"Loading...",sProcessing:"Yükleniyor...",sSearch:"Arama:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Kayıt bulunamadı"},
